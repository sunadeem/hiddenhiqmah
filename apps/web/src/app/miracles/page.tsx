...
const miracles: Miracle[] = [
  ...
  },
  {
    ...
    explanation: "Surah Al-Hadid (The Iron) is the 57th chapter of the Quran. Iron's atomic number is 26 — every iron atom has 26 protons. Its most common isotope, Fe-56, has a mass number of 56 (26 protons + 30 neutrons); a rarer stable isotope, Fe-57, matches the surah's number. Some researchers also note that the word 'al-hadid' first appears in verse 25 of this surah. These numerical connections between the surah number, verse positions, and iron's atomic properties are cited as remarkable.",
